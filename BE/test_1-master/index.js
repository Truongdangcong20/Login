...
const { register, login, changePass, deleteAccount, GetUserById, GetAll } = require('./repositories/user');
const { checkLogin, isLogin } = require('./middleware');
const { createCourse, deleteCourseById, deleteCourseByName, deleteCourseByTime,
    deleteCourseByType, deleteCourseByAddress, updateCourse, showAllCourse, showCourseByName, showCourseByTime,
    showCourseByType, showCourseByAddress } = require('./repositories/course');
